...
export const appThemes: Record<AppThemeId, AppTheme> = {
  indigo: {
    id: 'indigo',
    name: 'Budget Buddy',
    description: 'Warm cream, forest green, and a touch of amber.',
    background: '#F6F1EA',
    orbPrimary: '#E8F0E9',
    orbSecondary: '#F7E8CA',
    orbTertiary: '#EAF2EC',
    ...
    heroChip: '#E8F1EC',
    heroChipText: '#23443B',
    heroStatusGood: '#E5F2EA',
    heroStatusAlert: '#FFF0E1',
    heroStatusGoodText: '#276749',
    heroStatusAlertText: '#A45118',
    heroText: '#FFFFFF',
    heroMuted: '#6C7D76',
    heroPanel: '#FBF8F3',
    heroPanelSoft: '#F3EEE7',
    surface: '#FFFFFF',
    surfaceSoft: '#FBF8F3',
    surfaceTint: '#EEF4F0',
    surfaceMuted: '#FAF7F2',
    surfaceStrong: '#E8F1EC',
    text: '#183D34',
    textMuted: '#60736C',
    textSoft: '#83918C',
    placeholder: '#A6B0AC',
    ...
    accentText: '#23443B',
    accentBorder: '#B9CEC4',
    progressTrack: '#E8E3DC',
    progressGood: '#2F7D62',
    progressWarning: '#E6A53A',
    progressAlert: '#D96C5F',
  ...
  emerald: {
    id: 'emerald',
    name: 'Forest Night',
    description: 'Deep green with warm gold for a focused dark mode.',
    background: '#071A14',
    orbPrimary: '#0D5B47',
    orbSecondary: '#0D6B54',
    orbTertiary: '#106B54',
...
export const appThemeOrder: AppThemeId[] = ['indigo', 'garden', 'warmclay', 'emerald'];
...
export const quickPresets: QuickPreset[] = [
  ...
  { name: 'Groceries', planned: 500, bucket: 'needs', themeId: 'citrus', recurring: false },
...
const normalizeAppThemeId = (value: unknown, fallback: AppThemeId = 'indigo'): AppThemeId =>
  typeof value === 'string' && appThemeOrder.includes(value as AppThemeId)
    ? (value as AppThemeId)
    : fallback;
