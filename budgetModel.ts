...
export const appThemes: Record<AppThemeId, AppTheme> = {
  indigo: {
    id: 'indigo',
    name: 'Indigo Night',
    description: 'Deep indigo with vibrant cyan and emerald accents. Bold modern.',
    background: '#0F172A',
    orbPrimary: '#1E2A4A',
    orbSecondary: '#192340',
    orbTertiary: '#1A2847',
    ...
    heroMuted: '#475569',
    heroPanel: '#1E293B',
    heroPanelSoft: '#293548',
    surface: 'rgba(30, 41, 59, 0.95)',
    surfaceSoft: '#1E293B',
    surfaceTint: '#334155',
    surfaceMuted: '#0F172A',
    surfaceStrong: '#293548',
    text: '#F1F5F9',
    textMuted: '#CBD5E1',
    textSoft: '#94A3B8',
    placeholder: '#64748B',
    ...
    switchOff: '#475569',
    switchOn: '#0891B2',
    switchThumbOn: '#06B6D4',
    switchThumbOff: '#CBD5E1',
  },
  emerald: {
    id: 'emerald',
    name: 'Emerald Luxury',
    description: 'Deep emerald with golden and sapphire accents. Sophisticated modern.',
    background: '#082F49',
    orbPrimary: '#0D4A3F',
    orbSecondary: '#0E543D',
    orbTertiary: '#0D4A41',
    ...
    heroMuted: '#6EE7B7',
    heroPanel: '#064E3B',
    heroPanelSoft: '#0D6B51',
    surface: 'rgba(6, 78, 59, 0.95)',
    surfaceSoft: '#065F46',
    surfaceTint: '#047857',
    surfaceMuted: '#082F49',
    surfaceStrong: '#0D6B51',
    text: '#ECFDF5',
    textMuted: '#A7F3D0',
    textSoft: '#6EE7B7',
    placeholder: '#34D399',
  ...
  slate: {
    id: 'slate',
    name: 'Slate Storm',
    description: 'Dark slate with vibrant magenta and cyan. Bold and energetic.',
    background: '#0F172A',
    orbPrimary: '#1E293B',
    orbSecondary: '#334155',
    orbTertiary: '#1E2E50',
    ...
    switchOff: '#493554',
    switchOn: '#DB2777',
    switchThumbOn: '#EC4899',
    switchThumbOff: '#CBD5E1',
  },
  cobalt: {
    id: 'cobalt',
    name: 'Cobalt Electric',
    description: 'Deep cobalt with electric yellow and neon blue. High contrast modern.',
    background: '#0C1117',
    orbPrimary: '#161B22',
    orbSecondary: '#1C2128',
    orbTertiary: '#1A2027',
    ...
    progressGood: '#1A7F37',
    progressWarning: '#D29922',
    progressAlert: '#DA3633',
    successSurface: '#0D3D56',
    successText: '#58A6FF',
    warningSurface: '#6C2E1E',
    warningText: '#F0883E',
    alertSurface: '#3D2817',
    alertText: '#F85149',
    divider: '#30363D',
    ...
    switchOff: '#30363D',
    switchOn: '#1F6FEB',
    switchThumbOn: '#79C0FF',
    switchThumbOff: '#8B95A5',
  },
  breeze: {
    id: 'breeze',
    name: 'Breeze',
    description: 'Clean white with cool blue and cyan accents. Minimal and modern.',
    background: '#FFFFFF',
    orbPrimary: '#EFF6FF',
    orbSecondary: '#F0F9FF',
    orbTertiary: '#E0F2FE',
  ...
  garden: {
    id: 'garden',
    name: 'Garden',
    description: 'Light green with sage and teal accents. Fresh and natural.',
    background: '#FAFEF7',
    orbPrimary: '#F0FDF4',
    ...
    heroMuted: '#DCFCE7',
    heroPanel: '#FAFEF7',
    heroPanelSoft: '#E0FFE0',
    surface: '#FFFFFF',
    surfaceSoft: '#F7FEF5',
    surfaceTint: '#E0FFF7',
    surfaceMuted: '#F1F5F3',
    surfaceStrong: '#D1F3D1',
    text: '#15803D',
    textMuted: '#6B7280',
    textSoft: '#9CA3AF',
    placeholder: '#D1D5DB',
  ...
  coral: {
    id: 'coral',
    name: 'Coral Glow',
    description: 'Light coral and peach with vibrant coral accents. Warm and playful.',
    background: '#FFFAF5',
    orbPrimary: '#FEF1E6',
    orbSecondary: '#FDEAE0',
    orbTertiary: '#FCE4DD',
    ...
    switchOff: '#E5DFDE',
    switchOn: '#FB923C',
    switchThumbOn: '#FF6B35',
    switchThumbOff: '#FFFFFF',
  },
  lavender: {
    id: 'lavender',
    name: 'Lavender Dream',
    description: 'Soft lavender with purple and indigo accents. Elegant and modern.',
    background: '#FAF8FE',
    orbPrimary: '#F3E8FF',
    orbSecondary: '#F5E6FD',
    orbTertiary: '#EDE9FE',
  ...
  serenity: {
    id: 'serenity',
    name: 'Serenity',
    description: 'Soft blue and gray. Calm, peaceful, and soothing.',
    background: '#F8FAFB',
    orbPrimary: '#E9F0F5',
    orbSecondary: '#EEF4F8',
    orbTertiary: '#E8EFF5',
    ...
    switchOff: '#D7E8F3',
    switchOn: '#B3D8EA',
    switchThumbOn: '#4B9CC3',
    switchThumbOff: '#FFFFFF',
  },
  sage: {
    id: 'sage',
    name: 'Sage Rest',
    description: 'Soft muted greens. Natural and deeply calming.',
    background: '#F7F9F7',
    orbPrimary: '#E8EFE8',
    orbSecondary: '#EEF4EE',
    orbTertiary: '#E8EDE8',
    ...
    heroMuted: '#DFE8DF',
    heroPanel: '#F5F8F5',
    heroPanelSoft: '#EEF4EE',
    surface: '#FFFFFF',
    surfaceSoft: '#F5F8F5',
    surfaceTint: '#EEF4EE',
    surfaceMuted: '#F1F4F1',
    surfaceStrong: '#DFEADF',
    text: '#2D3D2D',
    textMuted: '#5A6D5A',
    textSoft: '#7A8B7A',
    placeholder: '#9BA99B',
    ...
    switchOff: '#D8E6D8',
    switchOn: '#C3D7C3',
    switchThumbOn: '#6B8E6B',
    switchThumbOff: '#FFFFFF',
  },
  warmclay: {
    id: 'warmclay',
    name: 'Warm Clay',
    description: 'Soft warm neutrals and earth tones. Cozy and grounded.',
    background: '#FAF7F5',
    orbPrimary: '#F0E8E3',
    orbSecondary: '#F5EFE9',
    orbTertiary: '#EEEBE5',
    ...
    switchOff: '#E5DAD2',
    switchOn: '#C9B8AD',
    switchThumbOn: '#9B7B65',
    switchThumbOff: '#FFFFFF',
  },
  twilight: {
    id: 'twilight',
    name: 'Twilight',
    description: 'Soft purples and cool grays. Gentle and serene.',
    background: '#F9F7FA',
    orbPrimary: '#EDE8F2',
    orbSecondary: '#F2EDF7',
    orbTertiary: '#E8E5EF',
